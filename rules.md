# FurniStack SaaS Platform — Project Architecture Rules

Production-grade web application development rules and standards for the Furniture SaaS e-commerce platform.
...
-Organize domain functionality in src/features.
-Store Prisma schema in prisma/schema.prisma.
-Keep tests separated by type.
-Avoid creating a separate frontend/backend application unless a future scaling requirement demands it. 
